...
pub const ACCOUNTING_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "财务专员",
        include_str!("../../../agency_experts/opc/industries/accounting/financial-clerk.md"),
    ),
    (
        "accounting-financial-approver",
        "财务审批人",
        include_str!("../../../agency_experts/opc/industries/accounting/financial-approver.md"),
    ),
    (
        "accounting-financial-assistant",
        "财务助理",
        include_str!("../../../agency_experts/opc/industries/accounting/financial-assistant.md"),
    ),
    (
        "accounting-financial-analyst",
        "财务分析师",
        include_str!("../../../agency_experts/opc/industries/accounting/financial-analyst.md"),
    ),
];
...
pub const FINANCE_INVEST_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "市场分析师",
        include_str!("../../../agency_experts/opc/industries/finance_invest/market-analyst.md"),
    ),
    (
        "finance-industry-researcher",
        "行业研究员",
        include_str!(
            "../../../agency_experts/opc/industries/finance_invest/industry-researcher.md"
        ),
    ),
    (
        "finance-asset-allocator",
        "资产配置专家",
        include_str!("../../../agency_experts/opc/industries/finance_invest/asset-allocator.md"),
    ),
    (
        "finance-trade-executor",
        "交易执行专家",
        include_str!("../../../agency_experts/opc/industries/finance_invest/trade-executor.md"),
    ),
    (
        "finance-portfolio-reviewer",
        "投资回顾专家",
        include_str!("../../../agency_experts/opc/industries/finance_invest/portfolio-reviewer.md"),
    ),
];
...
pub const GAME_DEV_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "游戏概念设计师",
        include_str!("../../../agency_experts/opc/industries/game_dev/concept-designer.md"),
    ),
    (
        "game-prototype-developer",
        "原型开发专家",
        include_str!("../../../agency_experts/opc/industries/game_dev/prototype-developer.md"),
    ),
    (
        "game-content-designer",
        "内容设计师",
        include_str!("../../../agency_experts/opc/industries/game_dev/content-designer.md"),
    ),
    (
        "game-qa-expert",
        "游戏QA专家",
        include_str!("../../../agency_experts/opc/industries/game_dev/qa-expert.md"),
    ),
    (
        "game-operations-expert",
        "游戏运营专家",
        include_str!("../../../agency_experts/opc/industries/game_dev/operations-expert.md"),
    ),
];
...
pub const DESIGN_EXPERTS: &[(&str, &str, &str)] = &[
    (
        "design-ui-designer",
        "UI设计师",
        include_str!("../../../agency_experts/opc/industries/design/ui-designer.md"),
    ),
    (
        "design-brand-strategist",
        "品牌设计师",
        include_str!("../../../agency_experts/opc/industries/design/brand-strategist.md"),
    ),
    (
        "design-system-architect",
        "设计系统专家",
        include_str!("../../../agency_experts/opc/industries/design/system-architect.md"),
    ),
];
...
pub const ECOMMERCE_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "选品专家",
        include_str!("../../../agency_experts/opc/industries/ecommerce/product-scout.md"),
    ),
    (
        "ecommerce-competitor-analyst",
        "竞品分析师",
        include_str!("../../../agency_experts/opc/industries/ecommerce/competitor-analyst.md"),
    ),
    (
        "ecommerce-marketing-planner",
        "营销专家",
        include_str!("../../../agency_experts/opc/industries/ecommerce/marketing-planner.md"),
    ),
];
...
pub const EDUCATION_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "课程设计师",
        include_str!("../../../agency_experts/opc/industries/education/curriculum-designer.md"),
    ),
    (
        "education-content-creator",
        "内容创作专家",
        include_str!("../../../agency_experts/opc/industries/education/content-creator.md"),
    ),
    (
        "education-assessment-expert",
        "评估专家",
        include_str!("../../../agency_experts/opc/industries/education/assessment-expert.md"),
    ),
];
...
pub const GEOSPATIAL_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "地理数据分析师",
        include_str!("../../../agency_experts/opc/industries/geospatial/data-analyst.md"),
    ),
    (
        "geospatial-visualization-expert",
        "可视化专家",
        include_str!("../../../agency_experts/opc/industries/geospatial/visualization-expert.md"),
    ),
    (
        "geospatial-planning-advisor",
        "规划顾问",
        include_str!("../../../agency_experts/opc/industries/geospatial/planning-advisor.md"),
    ),
];
...
pub const INDUSTRY_CONSULTING_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "行业研究员",
        include_str!(
            "../../../agency_experts/opc/industries/industry_consulting/research-analyst.md"
        ),
    ),
    (
        ...
        "战略顾问",
        include_str!(
            "../../../agency_experts/opc/industries/industry_consulting/strategy-advisor.md"
        ),
    ),
    (
        ...
        "实施教练",
        include_str!(
            "../../../agency_experts/opc/industries/industry_consulting/implementation-coach.md"
        ),
    ),
];
...
pub const PROJECT_MANAGEMENT_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "项目规划专家",
        include_str!(
            "../../../agency_experts/opc/industries/project_management/planning-expert.md"
        ),
    ),
    (
        ...
        "项目监控分析师",
        include_str!(
            "../../../agency_experts/opc/industries/project_management/monitoring-analyst.md"
        ),
    ),
    (
        ...
        "交付管理专家",
        include_str!(
            "../../../agency_experts/opc/industries/project_management/delivery-manager.md"
        ),
    ),
];
...
pub const SALES_GROWTH_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "线索生成专家",
        include_str!("../../../agency_experts/opc/industries/sales_growth/lead-generator.md"),
    ),
    (
        "sales-negotiation-expert",
        "谈判专家",
        include_str!("../../../agency_experts/opc/industries/sales_growth/negotiation-expert.md"),
    ),
    (
        "sales-growth-analyst",
        "增长分析师",
        include_str!("../../../agency_experts/opc/industries/sales_growth/growth-analyst.md"),
    ),
];
...
pub const SECURITY_EXPERTS: &[(&str, &str, &str)] = &[
    (
        ...
        "合规审计师",
        include_str!("../../../agency_experts/opc/industries/security/compliance-auditor.md"),
    ),
    (
        "security-incident-responder",
        "事件响应专家",
        include_str!("../../../agency_experts/opc/industries/security/incident-responder.md"),
    ),
    (
        "security-risk-assessor",
        "风险评估专家",
        include_str!("../../../agency_experts/opc/industries/security/risk-assessor.md"),
    ),
];
...
pub const SOFTWARE_DEV_EXPERTS: &[(&str, &str, &str)] = &[
    (
        "software-architect",
        "软件架构师",
        include_str!("../../../agency_experts/opc/industries/software_dev/architect.md"),
    ),
    (
        "software-developer",
        "开发专家",
        include_str!("../../../agency_experts/opc/industries/software_dev/developer.md"),
    ),
    (
        "software-quality-expert",
        "质量专家",
        include_str!("../../../agency_experts/opc/industries/software_dev/quality-expert.md"),
    ),
];
