...
#[agent_command(domain = "system", safety = Safe, call_mode = StateInput, description = "将使命分解为子任务工作流")]
#[tauri::command]
...
/// 每次调用创建独立的订阅，互不干扰。
#[agent_command(domain = "system", safety = Safe, call_mode = StateInput, description = "订阅编排器流式输出")]
#[tauri::command]
