    ...
    fn define_workflow_steps(&self) -> Vec<WorkflowStepDef> {
        ...
        vec![
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-finance_invest_lead-finance-market-analyst".to_string()),
            ...
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-finance_invest_lead-finance-industry-researcher".to_string()),
                error_handling: "stop".to_string(),
                order: 2,
                inputs: user_inputs.clone(),
            },
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-finance_invest_lead-finance-asset-allocator".to_string()),
                error_handling: "stop".to_string(),
                order: 3,
                inputs: user_inputs.clone(),
            },
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-finance_invest_lead-finance-trade-executor".to_string()),
            ...
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-finance_invest_lead-finance-portfolio-reviewer".to_string()),
                error_handling: "continue".to_string(),
                order: 5,
                inputs: user_inputs,
            },
