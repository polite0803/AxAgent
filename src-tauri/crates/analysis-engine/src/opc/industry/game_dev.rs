    ...
    fn define_workflow_steps(&self) -> Vec<WorkflowStepDef> {
        ...
        vec![
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-game_dev_lead-game-concept-designer".to_string()),
            ...
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-game_dev_lead-game-prototype-developer".to_string()),
                error_handling: "stop".to_string(),
                order: 2,
                inputs: user_inputs.clone(),
            },
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-game_dev_lead-game-content-designer".to_string()),
            ...
            WorkflowStepDef {
                ...
                agent_profile_id: Some("opc-game_dev_lead-game-qa-expert".to_string()),
                error_handling: "continue".to_string(),
                order: 4,
                inputs: user_inputs.clone(),
            },
            WorkflowStepDef {
                ...
                tools: vec!["WebSearch".to_string()],
                agent_profile_id: Some("opc-game_dev_lead-game-operations-expert".to_string()),
                error_handling: "continue".to_string(),
                order: 5,
                inputs: user_inputs,
            },
