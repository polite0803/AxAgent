    ...
    pub fn default_tools(&self) -> Vec<&'static str> {
        match self {
            AgentRole::Coordinator => vec![
                "web_search", "read_file", "list_directory", "search_files",
                "grep_content", "skill_manage", "session_search", "memory_flush",
                "get_system_info", "get_storage_info", "list_storage_files",
            ],
            AgentRole::Researcher => vec![
                "web_search", "fetch_url", "fetch_markdown", "read_file",
                "list_directory", "search_files", "grep_content", "search_knowledge",
                "list_knowledge_bases", "session_search",
                "list_storage_files", "download_storage_file",
            ],
            AgentRole::Developer => vec![
                "write_file", "edit_file", "read_file", "list_directory",
                "search_files", "grep_content", "run_command", "file_exists",
                "get_file_info", "create_directory", "delete_file", "move_file",
                "get_system_info", "list_processes",
                "get_storage_info", "list_storage_files",
                "upload_storage_file", "download_storage_file", "delete_storage_file",
            ],
            AgentRole::Reviewer => vec![
                "read_file", "list_directory", "search_files", "grep_content",
                "run_command", "file_exists", "get_file_info",
                "get_system_info", "list_processes",
            ],
            AgentRole::Browser => vec![
            ...
            AgentRole::Planner => vec![
                "read_file", "list_directory", "search_files", "grep_content",
                "web_search", "session_search", "memory_flush",
                "get_system_info", "get_storage_info", "list_storage_files",
            ],
            AgentRole::Executor => vec![
                "run_command", "write_file", "edit_file", "read_file",
                "list_directory", "search_files", "grep_content",
                "create_directory", "delete_file", "move_file", "file_exists",
                "get_system_info", "list_processes",
                "upload_storage_file", "download_storage_file", "delete_storage_file",
            ],
        }
