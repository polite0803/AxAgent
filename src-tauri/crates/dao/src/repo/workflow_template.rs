...
fn build_active_model_from_data(
    ...
    workflow_template::ActiveModel {
        ...
        is_preset: Set(if item.is_preset { 1 } else { 0 }),
        is_editable: Set(if item.is_editable { 1 } else { 0 }),
        is_public: Set(if item.is_public { 1 } else { 0 }),
...
pub fn template_model_to_data(
    ...
    WorkflowTemplateData {
        ...
        is_preset: model.is_preset != 0,
        is_editable: model.is_editable != 0,
