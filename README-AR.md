...
- **المهارات الذرية** — مكونات مهارات دقيقة تدعم بناء سير عمل معقد
- **تقسيم المهارات** — تقسيم المهام المعقدة تلقائياً إلى مهارات ذرية قابلة للتنفيذ
- **الأدوات المولدة** — ينشئ الذكاء الاصطناعي تلقائياً ويسجل أدوات جديدة لتوسيع قدرات الوكيل

### نظام سير العمل

- **محرر سير العمل** — مصمم سير عمل بصري قابل للسحب والإفلات مع توصيل وتكوين العقد
- **قوالب سير العمل** — пресеты مدمجة لبدء المهام الشائعة بسرعة
- **إدارة الإصدارات** — تدعم قوالب سير العمل إدارة الإصدارات مع إمكانية التراجع إلى إصدارات تاريخية
- **محرك سير العمل** — محرك تنفيذ سير عمل قوي يدعم التنفيذ المتوازي والشروطي والحلقي
- **تاريخ التنفيذ** — سجل مفصل لتاريخ تنفيذ سير العمل مع تتبع الحالة وتصحيح الأخطاء
- **مساعدة الذكاء الاصطناعي** — مساعدة الذكاء الاصطناعي في تصميم سير العمل، والإنشاء والتعظيم التلقائي
