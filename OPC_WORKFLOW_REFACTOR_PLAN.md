...
| 阶段 | 任务                                 | 状态 | 完成时间   |
| ---- | ------------------------------------ | ---- | ---------- |
| 一   | 1.1 创建业务负责人角色（按实际需要） | ✅   | 2026-08-13 |
| 一   | 1.2 创建行业专家 .md                 | ✅   | 2026-08-12 |
| 一   | 1.3 创建领域专家 .md                 | ✅   | 2026-08-13 |
| 一   | 1.4 更新种子化逻辑                   | ✅   | 2026-08-13 |
| 二   | 2.1 行业 seed 文件（14个）           | ✅   | 2026-08-13 |
| 二   | 2.2 领域 seed 文件（17个）           | ✅   | 2026-08-13 |
| 二   | 2.3 更新调度（mod.rs）               | ✅   | 2026-08-13 |
| 三   | 3.1 删除行业适配器                   | ✅   | 2026-08-13 |
| 三   | 3.2 删除领域生成器                   | ✅   | 2026-08-13 |
| 三   | 3.3 更新引用（industry_config等）    | ✅   | 2026-08-13 |
| 四   | 4.1 编译验证（零警告/错误）          | ✅   | 2026-08-13 |
| 四   | 4.2 种子化测试                       | ⏳   | -          |
| 四   | 4.3 工作流执行测试                   | ⏳   | -          |
