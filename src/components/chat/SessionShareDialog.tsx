              ...
              <Space direction="vertical" className="w-full">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={(v) =>
                      onPermissionsChange?.({ allow_terminal_access: v })
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={(v) =>
                      onPermissionsChange?.({ allow_file_access: v })
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={(v) =>
                      onPermissionsChange?.({ allow_model_access: v })
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onChange={(v) =>
                      onPermissionsChange?.({ require_approval_for_actions: v })
                    }
                  />
                </div>
              </Space>
