...
import { MessageSquarePlus, Search, Archive, ListTodo, Trash2, Pencil, Share, Pin, PinOff, Loader, X, Undo2, ArrowLeft, FileImage, FileCode, FileType, FileText, FolderPlus, FolderOpen, GripVertical, ChevronRight, MessageSquareText, Bot, Link2 } from 'lucide-react'
...
import { useConversationStore, useProviderStore, useSettingsStore, useCategoryStore, useStreamStore } from '@/stores'
