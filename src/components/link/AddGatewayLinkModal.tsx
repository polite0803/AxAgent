...
import type { GatewayLinkType, CreateGatewayLinkInput } from '@/types';
    ...
    >
      ...
      >
        ...
        <Form.Item
          ...
          rules={[{ required: true }]}
        >
          <Select options={LINK_TYPES.map((lt) => ({ value: lt.value, label: lt.labelKey.startsWith('link.') ? t(lt.labelKey) : lt.labelKey }))} />
        </Form.Item>
