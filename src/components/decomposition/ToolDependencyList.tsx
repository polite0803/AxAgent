...
import {
  CheckCircleOutlined, WarningOutlined, ToolOutlined, ThunderboltOutlined,
...
export const ToolDependencyList: React.FC<ToolDependencyListProps> = ({
  dependencies, onAction, actionLoading,
}) => {
  const columns = [
    { title: '工具名称', dataIndex: 'name', key: 'name' },
    {
      title: '类型', dataIndex: 'tool_type', key: 'tool_type', width: 80,
    ...
    {
      title: '安装说明', dataIndex: 'install_instructions', key: 'install_instructions',
      ellipsis: true,
