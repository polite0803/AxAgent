...
/**
 * 多因子筛选面板(原 StockScreenerPanel "screen" 模式)。
 *
 * 启动后空着,等用户在自选股(空时回退到 FALLBACK 池)上勾选
 * 因子 + 调阈值,然后点"筛选"按钮出结果。
 *
 * 注:本组件不负责"今日发现" / "自动加载热门候选" —— 那一类需求
 * 已被 <RecommendationPanel> 的智能荐股完全覆盖,合并到选股中心后
 * 不再重复暴露。
 */
