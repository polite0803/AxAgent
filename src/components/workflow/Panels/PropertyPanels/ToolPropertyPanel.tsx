...
import type { WorkflowNode, ToolNode } from '../../types';
...
const TOOL_OPTIONS = [
  ...
  { value: 'audio_transcription', label: '🎙️ 语音转文字' },
  { value: 'send_email', label: '📧 发送邮件' },
  { value: 'http_request', label: '🌍 HTTP 请求' },
  { value: 'database_query', label: '🗄️ 数据库查询' },
  { value: 'slack_message', label: '💬 Slack 消息' },
