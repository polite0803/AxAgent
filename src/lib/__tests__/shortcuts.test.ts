...
const mockSettings = (
  ...
  ({
    ...
    shortcutToggleCurrentWindow: "",
    shortcutToggleAllWindows: "",
    shortcutCloseWindow: "",
    shortcutNewConversation: "",
    shortcutOpenSettings: "",
    shortcutToggleModelSelector: "",
    shortcutFillLastMessage: "",
    shortcutClearContext: "",
    shortcutClearConversationMessages: "",
    shortcutToggleGateway: "",
    shortcutToggleMode: "",
    shortcutShowQuickBar: "",
    globalShortcut: "",
    ...overrides,
    // Stub required AppSettings fields so TS cast succeeds
    language: "zh-CN",
    themeMode: "dark",
    themePreset: "dark-elegance",
    primaryColor: "#17A93D",
    borderRadius: 8,
    autoStart: false,
    showOnStart: true,
