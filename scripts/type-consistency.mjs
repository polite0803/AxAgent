...
const RUST_COMMANDS = [
  // Conversation
  'list_conversations', 'create_conversation', 'update_conversation', 'delete_conversation',
  'toggle_pin_conversation', 'toggle_archive_conversation', 'list_archived_conversations',
  'regenerate_conversation_title', 'branch_conversation',
  // Messages
  'send_message', 'regenerate_message', 'regenerate_with_model', 'send_system_message',
  'delete_message', 'clear_conversation_messages', 'list_messages', 'list_messages_page',
  'load_older_messages', 'switch_message_version', 'list_message_versions',
  'update_message_content', 'delete_message_group', 'cancel_stream',
  // Multi-model
  'send_multi_model_message',
  // Providers
  'list_providers', 'create_provider', 'update_provider', 'delete_provider',
  'toggle_provider', 'list_models', 'list_provider_keys', 'create_provider_key',
  'delete_provider_key',
  // Categories
  'list_conversation_categories', 'create_conversation_category', 'update_conversation_category',
  'delete_conversation_category',
  // Settings
  'get_settings', 'save_settings',
  // Knowledge
  'list_knowledge_bases', 'create_knowledge_base', 'update_knowledge_base', 'delete_knowledge_base',
  'list_knowledge_documents', 'index_knowledge_document', 'delete_knowledge_document',
  'search_knowledge', 'collect_rag_context',
  // Memory
  'list_memory_namespaces', 'create_memory_namespace', 'update_memory_namespace',
  'delete_memory_namespace', 'list_memory_items', 'create_memory_item', 'update_memory_item',
  'delete_memory_item', 'search_memory',
  // MCP
  'list_mcp_servers', 'create_mcp_server', 'update_mcp_server', 'delete_mcp_server',
  'list_tools_for_server', 'execute_mcp_tool',
  // Gateway
  'gateway_status', 'gateway_start', 'gateway_stop', 'gateway_restart',
  'list_gateway_keys', 'create_gateway_key', 'delete_gateway_key',
  'get_gateway_metrics', 'get_gateway_logs',
  // Agent
  'agent_query', 'agent_cancel', 'agent_approve', 'agent_pause', 'agent_resume',
  'agent_get_session', 'agent_update_session', 'agent_respond_ask',
  'agent_backup_and_clear_sdk_context', 'agent_restore_sdk_context_from_backup',
  // Skills
  'list_skills', 'install_skill', 'create_skill', 'delete_skill',
  'list_skill_proposals', 'approve_skill_proposal', 'reject_skill_proposal',
  // Workflow
  'list_workflow_templates', 'get_workflow_template', 'create_workflow_template',
  'update_workflow_template', 'delete_workflow_template', 'duplicate_workflow_template',
  'validate_workflow_template', 'export_workflow_template', 'import_workflow_template',
  'get_template_versions', 'get_template_by_version',
  'generate_workflow_from_prompt', 'optimize_agent_prompt', 'recommend_nodes',
  // Files
  'list_stored_files', 'delete_stored_file', 'file_cleanup',
  // Backup / WebDAV
  'create_backup', 'list_backups', 'restore_backup', 'delete_backup',
  'get_webdav_status', 'webdav_sync', 'clear_webdav_cache',
  // Workspace
  'get_workspace_snapshot', 'update_workspace_snapshot',
  'fork_conversation', 'compare_responses',
  // Desktop
  'force_quit', 'set_window_size',
  // Search
  'search_conversations',
  // Tools
  'list_tool_executions',
  // Atomic skills
  'list_atomic_skills', 'get_atomic_skill', 'create_atomic_skill', 'update_atomic_skill',
  'delete_atomic_skill',
  // Local tools
  'list_local_tools', 'create_local_tool', 'delete_local_tool',
  // Generated tools
  'list_generated_tools', 'create_generated_tool', 'delete_generated_tool',
  // Work engine
  'work_engine_status', 'work_engine_execute',
  // Decomposition
  'decompose_task', 'get_decomposition_status',
  // Analytics / nudge / insight
  'get_nudges', 'dismiss_nudge', 'get_insights',
  'get_conversation_stats',
  // Platform integration
  'list_platform_integrations', 'create_platform_integration',
  'update_platform_integration', 'delete_platform_integration',
  'execute_platform_action',
  // Scheduled tasks
  'list_scheduled_tasks', 'create_scheduled_task', 'update_scheduled_task',
  'delete_scheduled_task', 'execute_scheduled_task',
  // Parallel execution
  'list_parallel_executions', 'cancel_parallel_execution',
  // Nudge
  'list_nudges', 'nudge_action',
];
...
const knownBrowserCommands = new Set([
  ...
  'send_message', 'list_messages', 'delete_message',
