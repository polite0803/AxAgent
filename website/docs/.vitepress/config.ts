...
export default defineConfig({
  title: 'AxAgent',
  description: 'AxAgent — Open-source AI desktop client with built-in AI gateway, multi-model chat, MCP server support. Connect OpenAI, Claude, Gemini and more LLMs in one app.',
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: 'AxAgent, AI desktop client, AI gateway, AI chat client, LLM client, multi-model AI, MCP server, OpenAI client, Claude client, Gemini client, AI assistant, desktop AI app, open source AI, ChatGPT alternative, AI aggregator, large language model, AI desktop application, Tauri AI app' }],
  ...
  locales: {
    root: {
      ...
      lang: 'en',
      title: 'AxAgent',
      description: 'AxAgent — Open-source AI desktop client with built-in AI gateway, multi-model chat, MCP server support.',
      themeConfig: {
        nav: [
          { text: 'Home', link: '/' },
    ...
    ja: {
      ...
      link: '/ja/',
      title: 'AxAgent',
      description: 'AxAgent — オープンソースのAIデスクトップクライアント。AIゲートウェイ内蔵、マルチモデルチャット、MCPサーバー対応。',
      themeConfig: {
        nav: [
          { text: 'ホーム', link: '/ja/' },
    ...
    fr: {
      ...
      link: '/fr/',
      title: 'AxAgent',
      description: 'AxAgent — Client de bureau IA open-source avec passerelle IA intégrée, chat multi-modèles, support serveur MCP.',
      themeConfig: {
        nav: [
    ...
    de: {
      ...
      link: '/de/',
      title: 'AxAgent',
      description: 'AxAgent — Open-Source KI-Desktop-Client mit integriertem KI-Gateway, Multi-Modell-Chat, MCP-Server-Unterstützung.',
      themeConfig: {
        nav: [
    ...
    es: {
      ...
      link: '/es/',
      title: 'AxAgent',
      description: 'AxAgent — Cliente de escritorio IA de código abierto con pasarela IA integrada, chat multi-modelo, soporte de servidor MCP.',
      themeConfig: {
        nav: [
          { text: 'Inicio', link: '/es/' },
    ...
    ru: {
      ...
      link: '/ru/',
      title: 'AxAgent',
      description: 'AxAgent — Настольный ИИ-клиент с открытым исходным кодом. Встроенный шлюз ИИ, чат с несколькими моделями, поддержка MCP-серверов.',
      themeConfig: {
        nav: [
