...
- **원자 스킬** — 복잡한 워크플로 구축을 지원하는 세분화된 스킬 구성 요소
- **스킬 분해** — 복잡한 작업을 실행 가능한 원자 스킬로 자동 분해
- **생성 도구** — AI가 새로운 도구를 자동으로 생성하고 등록하여 에이전트 능력 확장

### 워크플로 시스템

- **워크플로 편집기** — 노드 연결 및 구성이 가능한 시각적 드래그 앤 드롭 워크플로 디자이너
- **워크플로 템플릿** — 일반 작업을 위한 내장 프리셋
- **버전 관리** — 워크플로 템플릿은 버전 관리를 지원하여 이력 버전으로 롤백 가능
- **워크플로 엔진** — 병렬, 조건, 루프 실행을 지원하는 강력한 워크플로 실행 엔진
- **실행 이력** — 워크플로 실행 이력을 자세히 기록하고 상태 추적 및 디버깅 지원
- **AI 지원** — 워크플로 디자인의 AI 지원, 자동 생성 및 최적화
